...
assert_plan "0.25.0-RC1" "0.25.0-RC2" "" "0.25.0-rc1-to-0.25.0-rc2.yaml" ""
assert_plan "0.25.0-RC2" "0.25.0-RC2" "" "0.25.0-rc1-to-0.25.0-rc2.yaml" ""
assert_plan "0.25.0-rc2" "0.25.0-rc3" "" \
  "0.25.0-rc1-to-0.25.0-rc2.yaml 0.25.0-rc2-to-0.25.0-rc3.yaml" ""
assert_plan "0.25.0-RC1" "0.25.0-RC3" "0.25.0-RC2" \
  "0.25.0-rc1-to-0.25.0-rc2.yaml 0.25.0-rc2-to-0.25.0-rc3.yaml" "0.25.0-rc1-to-0.25.0-rc2.yaml"
