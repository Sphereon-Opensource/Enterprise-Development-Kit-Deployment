...
V0_25_0_RC4_TO_V0_25_0_RC5_VALUES="$DEPLOYMENT_ROOT/helm/edk-enterprise/examples/upgrades/0.25.0-rc4-to-0.25.0-rc5-values.yaml"
...
if [[ -n "$INSTALLED_IMAGE_TAG" && -n "$IMAGE_TAG" ]]; then
  if ! edk_plan_known_upgrade_path \
    ...
    "$(absolute_file "$V0_25_0_RC3_TO_V0_25_0_RC4_VALUES")" \
    "$(absolute_file "$V0_25_0_RC4_TO_V0_25_0_RC5_VALUES")"; then
