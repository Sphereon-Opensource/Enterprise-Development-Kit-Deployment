...
edk_plan_known_upgrade_path() {
  ...
  local v0_25_0_rc4_to_v0_25_0_rc5_values="${6:-}"
  ...
  if [[ -n "$v0_25_0_rc4_to_v0_25_0_rc5_values" &&
        "$installed_release_number" -gt 0 && "$target_release_number" -ge 5 ]]; then
    EDK_AUTO_MIGRATION_VALUE_FILES+=("$v0_25_0_rc4_to_v0_25_0_rc5_values")
  fi
